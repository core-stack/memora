...
-- CreateIndex
CREATE INDEX "Group_tenant_id_idx" ON "public"."Group"("tenant_id");

-- CreateIndex
CREATE UNIQUE INDEX "Group_tenant_id_slug_key" ON "public"."Group"("tenant_id", "slug");
...
-- AddForeignKey
ALTER TABLE "public"."Group" ADD CONSTRAINT "Group_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "public"."Group"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."sources" ADD CONSTRAINT "sources_group_id_fkey" FOREIGN KEY ("group_id") REFERENCES "public"."Group"("id") ON DELETE CASCADE ON UPDATE CASCADE;
