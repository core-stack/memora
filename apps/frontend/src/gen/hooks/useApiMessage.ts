 ...
 */
export async function message({ tenantId, knowledgeId, chatId, params }: { tenantId: MessagePathParams["tenantId"]; knowledgeId: MessagePathParams["knowledgeId"]; chatId: MessagePathParams["chatId"]; params?: MessageQueryParams }, config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
...
export function messageQueryOptions({ tenantId, knowledgeId, chatId, params }: { tenantId: MessagePathParams["tenantId"]; knowledgeId: MessagePathParams["knowledgeId"]; chatId: MessagePathParams["chatId"]; params?: MessageQueryParams }, config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
 ...
 * {@link /api/tenant/:tenantId/knowledge/:knowledgeId/chat/:chatId/message}
 */
export function useApiMessage<TData = MessageQueryResponse, TQueryData = MessageQueryResponse, TQueryKey extends QueryKey = MessageQueryKey>({ tenantId, knowledgeId, chatId, params }: { tenantId: MessagePathParams["tenantId"]; knowledgeId: MessagePathParams["knowledgeId"]; chatId: MessagePathParams["chatId"]; params?: MessageQueryParams }, options: 
{
